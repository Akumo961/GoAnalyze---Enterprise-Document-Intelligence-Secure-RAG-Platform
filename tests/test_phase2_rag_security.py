...
from gov_platform.rag_engine import ProductionRAG, contains_prompt_injection, retrieve


def citation(text: str, doc: str | None = None) -> EvidenceCitation:
    return EvidenceCitation(
        document_id=uuid4() if doc is None else uuid4(),
        version=1,
        chunk_id="0",
        sha256="a" * 64,
        excerpt=text,
